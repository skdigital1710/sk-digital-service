...
const emptyForm = {
  ...
  jobLocation: "", applicationStartDate: "", lastDate: import React, { useEffect, useMemo, useState } from "react";
import "./Admin.css";
import {
  BarChart3, Bell, CheckCircle2, Edit3, ExternalLink, Eye, FileText,
  FolderOpen, Image as ImageIcon, LayoutDashboard, Link as LinkIcon,
...
function Admin() {
  ...
  async function uploadFile(file,pathPrefix){
    ...
    const {error:e}=await supabase.storage.from(pathPrefix.includes("thumb")?"resource-thumbnails":"resources").upload(path,file,{upsert:false});
...
export default Admin;"", applyUrl: "", notificationUrl: "", officialWebsiteUrl: "",
  resourceType: "pdf", isFree: true, price: "", tags: "", isPublished: false, isFeatured: false,
  file: null, image: null,
};
